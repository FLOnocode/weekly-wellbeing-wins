/*
  # Create challenge rules table and update scoring system
  ...
  3. Default Rules
    - Insert updated scoring rules including new daily completion bonus
    - Remove difficult challenge bonus as requested
